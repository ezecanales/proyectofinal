<?php
    ...
    if(isset($_POST) && !empty($_POST)){
        ...
        $res = $resenias->insertarResenia($idprod, $img, $tipoproducto, $nombreprod, $tiempouso, $marca, $lugarcompra, $descripcion);
        if($res){
            header("Location: ../mostrarReseñas.php?msg=1");
        }else{
            header("Location: ../mostrarReseñas.php?msg=4");
        }
    }
?>